...
- ## 简介
	- ### 概述
	- 本项目的目标是开发一个集成ROS（Robot Operating System）、Unity和MuJoCo的仿真平台，具备高精度的物理仿真、灵活的环境建模、传感器模拟以及基于大语言模型的AI动作绑定和人机协作。通过容器化简化部署，并集成Hololens 2进行场景可视化和人体动作捕捉。该平台还支持通过照片生成场景并扩展类似场景，以及优化人机协作的数据集生成流程。
	- ### 竞品分析
...
- ## 目标
	...
	- 8. 语言生成模型+AI动作绑定
	- 9. 多机协作优化
	- 10. 人机协作优化，基于Hololens2的机器人和场景可视化，以及人体动作捕捉
	- 11. 人机协作数据集生产优化
- ## 技术难题
...
- ## 技术路径
	...
	- 2. 功能模块设计
		...
		- •	Hololens 2 集成：微软提供了Hololens的开发者工具，支持与Unity的集成。可以参考微软的Mixed Reality Toolkit (MRTK)进行开发。
		  ...
		  •	AR 场景交互：可以结合Unity的XR插件（如AR Foundation）进行AR交互开发，具体参考Unity的AR Foundation文档。
		  •	实现方案参考：
		  •	Unity AR Foundation提供了相关的AR场景交互示例代码。
		- 2.3 大语言模型 + AI 动作生成
...
- ## 实现进展
- ### 架构图
	- ![image.png](../assets/image_1727075194675_0.png){:height 265, :width 565}
- ### Roadmap
	- ✅ MuJoCo
